...
//}
//
//func (nid *NFTID) MarshalText() ([]byte, error) {
//	fmt.Println(strconv.FormatUint(nid.Index(), 10))
//	return []byte(strconv.FormatUint(nid.Index(), 10)), nil
//}
//
//func (nid *NFTID) UnmarshalText(b []byte) error {
